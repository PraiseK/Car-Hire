<template>
  <section class="flex flex-col">
    <template v-if="availableVerhicles.length > 0">
      ...
      >
        <div class="container px-5 mx-auto">
          ...
          >
            <div
              class="sm:mr-10 inline-flex items-center justify-center flex-shrink-0"
            >
              <img
                :src="verhicle.imgDir"
                alt="verhicle"
              ...
              <div class="py-4">
                <div class="inline-block mr-2">
                  <div class="flex pr-2 h-full items-center">
                    ...
                    <p class="title-font font-medium">{{ verhicle.seats }}</p>
                  </div>
                </div>
                <div class="inline-block mr-2">
                  <div class="flex pr-2 h-full items-center">
                ...
                <div class="inline-block mr-2">
                  <div class="flex pr-2 h-full items-center">
                    ...
                    <p class="title-font font-medium">{{ verhicle.carType }}</p>
                  </div>
                </div>
    ...
    <template v-else>
      <!-- component -->
      <div class="w-full py-24 flex flex-col items-center justify-between">
        <div
          class="xl:w-1/2 flex-1 flex flex-col items-center justify-center text-center lg:px-0"
        >
          <svg
            class="w-3/4"
            xmlns="http://www.w3.org/2000/svg"
          ...
          <p class="text-xl text-gray-700 uppercase mt-4">
